...
export const fallbackEvents: EventRow[] = [
  ...
  {
    id: "fallback-5",
    title: "October Shine Social",
    description: "Everyone invited! Grab a coffee with us and meet new friends.",
  ...
  },
  {
    id: "fallback-6",
    title: "Prayer Walk",
    description: "No prayer experience needed! Come enjoy nature, a walk, and prayer time.",
    event_date: "2026-10-31",
    event_time: null,
    location: null,
    highlight: "sage",
